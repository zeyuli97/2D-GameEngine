...
public class MouseControl extends Component {
  ...
  public void editorUpdate(double dt) {
    if (holdingObj != null) {
      ...
      //System.out.println("This is OX: " + MouseListener.getOrthoX() + "and this is OY" + MouseListener.getOrthoY());
      //System.out.println("This is RX" + MouseListener.getxPos() + "and this is RY" + MouseListener.getyPos());
