...
public class RaycastInfo implements RayCastCallback {
  public Fixture fixture; // The object we will hit.
  public Vector2f point; // The point where we will hit.
  public Vector2f normal; // the normal of hit.
  public float fraction; // Fraction between p1 and p2.
  public boolean hit;
