...
public class Prefabs {
  ...
  public static GameObject generateMushroom() {
    SpriteSheet items = AssetPool.getSpriteSheet("assets/images/items.png");
    GameObject mushroom = generateSpriteWithinGameObject(items.getSprite(10), 0.25f, 0.25f);
  ...
  public static GameObject generateFlower() {
    SpriteSheet items = AssetPool.getSpriteSheet("assets/images/items.png");
    GameObject flower = generateSpriteWithinGameObject(items.getSprite(20), 0.25f, 0.25f);
  ...
  public static GameObject generateGoomba() {
    ...
    GameObject goomba = generateSpriteWithinGameObject(sprites.getSprite(14), 0.25f, 0.25f);
